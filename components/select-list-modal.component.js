    ...
    const RenderItem = ({item}) => {
        return (
            <TouchableOpacity style={[{
                ...
                <Text style={{color: BLACK_COLOR, fontSize: getFontScaledSize(23)}}>{item.name}</Text>
            </TouchableOpacity>
        );
    }
            ...
            <View style={styles.container}>
                ...
                <View style={styles.footerContainer}>
                    <TouchableOpacity style={styles.cancelButton} onPress={() => props.toggleShown()}>
                        <XMarkIcon size={getFontScaledSize(36)} color={ORANGE_COLOR}/>
                        <Text style={styles.buttonText}>Cancel</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.confirmButton} onPress={() => handleConfirmData()}>
                        <CheckIcon color={WHITE_COLOR} size={getFontScaledSize(23)}/>
